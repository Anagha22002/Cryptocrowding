const Card = ({ allcampaign, setOpenModel, setDonate, title }) => {
    console.log("allcampaign is " + allcampaign);
          ...
          {allcampaign?.map((campaign, i) => (
            ...
            >
              ...
              <div className="py-5 pl-2">
                ...
                href="/"
                aria-label="Article"
                className="inlint-block mb-3 text-black transition-colors duration-200 hover:text-deep-purple-accent-700">
                  <p className="text-2xl font-bold leading-5">{campaign.title}</p>
                </a>
                <p className="mb-4 text-gray-700">{campaign.description|| "No Description Available"}</p>
